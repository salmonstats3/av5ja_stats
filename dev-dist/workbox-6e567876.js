define(["exports"], function (exports) {
  ...
  const messages = {
    ...
    "incorrect-type": ({ expectedType, paramName, moduleName, className, funcName }) => {
      ...
      return (
        `The parameter '${paramName}' passed into ` + `'${moduleName}.${classNameStr}` + `${funcName}()' must be of type ${expectedType}.`
      );
    },
    ...
    "cross-origin-copy-response": ({ origin }) => {
      return (
        `workbox-core.copyResponse() can only be used with same-origin ` + `responses. It was passed a response with origin ${origin}.`
      );
    },
